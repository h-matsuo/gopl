...
// Token contains Symbol, String, Int, StartList and EndList.
type Token interface{}
type Symbol struct { // e.g., foo (name w/o quote)
	Name string
}
type String struct { // e.g., "hello"
	Value string
}
type Int struct { // e.g., 42
	Value int
}
type StartList struct { // e.g., (1 2 3
	Tokens []Token
}
type EndList struct { // )
}

// TODO: p.247 の main() のような API で実装?
